...
from ..schemas.enums import ShoppingCategory
...
class ShoppingList(Base):
    ...
    creator = relationship(
        "User", back_populates="created_shopping_lists", foreign_keys=[created_by]
    )
    shopper = relationship(
        "User",
        back_populates="assigned_shopping_lists",
        foreign_keys=[assigned_shopper],
    )
    items = relationship(
...
class ShoppingItem(Base):
    ...
    category = Column(String, default=ShoppingCategory.HOUSEHOLD.value)
    ...
    requester = relationship(
        "User", back_populates="requested_shopping_items", foreign_keys=[requested_by]
    )
