...
class Bill(Base):
    ...
    created_by_user = relationship("User", back_populates="created_bills", foreign_keys=[created_by])
...
class BillPayment(Base):
    ...
    paid_by_user = relationship("User", back_populates="bill_payments", foreign_keys=[paid_by])
