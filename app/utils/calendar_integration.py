...
class CalendarService:
    ...
    def check_all_conflicts(self, start_time: datetime, end_time: datetime) -> Dict[str, List[CalendarEvent]]:
        ...
        if self.google_integration:
            conflicts['google'] = self.google_integration.check_conflicts(start_time, end_time)
        
        if self.apple_integration:
            conflicts['apple'] = self.apple_integration.check_conflicts(start_time, end_time)
    ...
    def sync_roomly_event_to_calendar(
        ...
        calendar_event = CalendarEvent(
            ...
            end_time=roomly_event['end_date'] or roomly_event['start_date'] + timedelta(hours=2),
    ...
    def get_user_availability(
        ...
        return {
            ...
            'conflicts': conflicts,
            'availability_score': max(0, 100 - (total_conflicts * 25))  # Reduce score by 25 per conflict
        }
