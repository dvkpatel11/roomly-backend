...
from ..schemas.task import (
    ...
    TaskLeaderboard, TaskStatus, TaskPriority
)
...
async def get_tasks(
    ...
    tasks = []  # task_service.get_household_tasks(current_user.household_id, status, assigned_to, skip, limit)
...
async def get_overdue_tasks(
    ...
    household_overdue = [
        ...
        if task.household_id == current_user.household_id
    ]
